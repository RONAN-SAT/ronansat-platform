  ...
  return (
    <div className="mb-4 flex items-center justify-between rounded-[24px] border border-white/70 bg-white/66 px-4 py-3 shadow-[0_14px_40px_rgba(148,163,184,0.14)] backdrop-blur-xl">
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="text-[22px] font-semibold tracking-[-0.03em] text-slate-950">Fix Board</div>
          <div className="text-[12px] text-slate-500">Grouped student error reports for admin review</div>
        </div>
      </div>
    </div>
  );
